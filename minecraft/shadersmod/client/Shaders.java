...
public class Shaders
{
    ...
    private static void checkWorldChanged(World world)
    {
        ...
        {
            World theWorld = currentWorld;
            currentWorld = theWorld;

            if (theWorld != null && theWorld != null)
            {
                int i = theWorld.provider.getDimensionType().getId();
                int j = theWorld.provider.getDimensionType().getId();
...
//TODO fix?      fogMode = fogMode.capabilityId;
            ...
            try
            {
                for (String s3 : list)
                {
                    ...
                    if (inputstream != null)
                    {
                        ...
                        {
                            String s5s = properties.getProperty((String)s4);
                            String s4s = (String)s4;
                            shaderPackResources.put(s4s, s5s);
                        }
                    }
                }
            }
