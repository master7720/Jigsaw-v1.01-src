...
public class ChunkUtils
{
    ...
    private static ReflectorField findFieldHasEntities(Chunk p_findFieldHasEntities_0_)
    {
        try
        {
            ...
            for (Object field1obj : list)
            {
                list2.add(((Field)field1obj).get(p_findFieldHasEntities_0_));
            }

            p_findFieldHasEntities_0_.setHasEntities(true);
            List list3 = new ArrayList();

            for (Object field2obj : list)
            {
                list3.add(((Field)field2obj).get(p_findFieldHasEntities_0_));
            }
