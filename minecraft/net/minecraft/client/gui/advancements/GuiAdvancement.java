...
public class GuiAdvancement extends Gui
{
    ...
    public GuiAdvancement(GuiAdvancementTab p_i47385_1_, Minecraft p_i47385_2_, Advancement p_i47385_3_, DisplayInfo p_i47385_4_)
    {
        ...
        this.field_191831_i = p_i47385_2_.fontRenderer.trimStringToWidth(p_i47385_4_.func_192297_a().getFormattedText(), 163);
    ...
    private List<String> func_192995_a(String p_192995_1_, int p_192995_2_)
    {
        ...
        {
            List<String> list = this.field_191833_k.fontRenderer.listFormattedStringToWidth(p_192995_1_, p_192995_2_);
            ...
            else
            {
                ...
                int i = this.field_191833_k.fontRenderer.getStringWidth(s + ' ' + s1.split(" ")[0]);

                if (i - p_192995_2_ <= 10)
                {
                    return this.field_191833_k.fontRenderer.listFormattedStringToWidth(p_192995_1_, i);
                }
                else
                {
                    ...
                    if (matcher.matches())
                    {
                        int j = this.field_191833_k.fontRenderer.getStringWidth(matcher.group(1));

                        if (p_192995_2_ - j <= 10)
                        {
                            return this.field_191833_k.fontRenderer.listFormattedStringToWidth(p_192995_1_, j);
                        }
                    }
    ...
    public void func_191821_a(int p_191821_1_, int p_191821_2_, float p_191821_3_, int p_191821_4_, int p_191821_5_)
    {
        ...
        int i = s == null ? 0 : this.field_191833_k.fontRenderer.getStringWidth(s);
        boolean flag1 = 113 - p_191821_2_ - this.field_191826_p - 26 <= 6 + this.field_192997_l.size() * this.field_191833_k.fontRenderer.FONT_HEIGHT;
        float f = this.field_191836_n == null ? 0.0F : this.field_191836_n.func_192103_c();
        ...
        int j1 = 32 + this.field_192997_l.size() * this.field_191833_k.fontRenderer.FONT_HEIGHT;
        ...
        if (flag)
        {
            this.field_191833_k.fontRenderer.drawString(this.field_191831_i, (float)(i1 + 5), (float)(p_191821_2_ + this.field_191826_p + 9), -1, true);

            if (s != null)
            {
                this.field_191833_k.fontRenderer.drawString(s, (float)(p_191821_1_ + this.field_191837_o - i), (float)(p_191821_2_ + this.field_191826_p + 9), -1, true);
            }
        }
        else
        {
            this.field_191833_k.fontRenderer.drawString(this.field_191831_i, (float)(p_191821_1_ + this.field_191837_o + 32), (float)(p_191821_2_ + this.field_191826_p + 9), -1, true);

            if (s != null)
            {
                this.field_191833_k.fontRenderer.drawString(s, (float)(p_191821_1_ + this.field_191837_o + this.field_191832_j - i - 5), (float)(p_191821_2_ + this.field_191826_p + 9), -1, true);
            }
        }
        ...
        if (flag1)
        {
            ...
            {
                this.field_191833_k.fontRenderer.drawString(this.field_192997_l.get(k1), (float)(i1 + 5), (float)(l + 26 - j1 + 7 + k1 * this.field_191833_k.fontRenderer.FONT_HEIGHT), -5592406, false);
            }
        }
        else
        {
            ...
            {
                this.field_191833_k.fontRenderer.drawString(this.field_192997_l.get(l1), (float)(i1 + 5), (float)(p_191821_2_ + this.field_191826_p + 9 + 17 + l1 * this.field_191833_k.fontRenderer.FONT_HEIGHT), -5592406, false);
            }
        }
