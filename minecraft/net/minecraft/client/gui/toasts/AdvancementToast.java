...
public class AdvancementToast implements IToast
{
    ...
    public IToast.Visibility func_193653_a(GuiToast p_193653_1_, long p_193653_2_)
    {
        ...
        if (displayinfo != null)
        {
            List<String> list = p_193653_1_.func_192989_b().fontRenderer.listFormattedStringToWidth(displayinfo.func_192297_a().getFormattedText(), 125);
            int i = displayinfo.func_192291_d() == FrameType.CHALLENGE ? 16746751 : 16776960;

            if (list.size() == 1)
            {
                p_193653_1_.func_192989_b().fontRenderer.drawString(I18n.format("advancements.toast." + displayinfo.func_192291_d().func_192307_a()), 30, 7, i | -16777216);
                p_193653_1_.func_192989_b().fontRenderer.drawString(displayinfo.func_192297_a().getFormattedText(), 30, 18, -1);
            }
            else
            {
                int j = 1500;
                ...
                if (p_193653_2_ < 1500L)
                {
                    ...
                    p_193653_1_.func_192989_b().fontRenderer.drawString(I18n.format("advancements.toast." + displayinfo.func_192291_d().func_192307_a()), 30, 11, i | k);
                }
                else
                {
                    int i1 = MathHelper.floor(MathHelper.clamp((float)(p_193653_2_ - 1500L) / 300.0F, 0.0F, 1.0F) * 252.0F) << 24 | 67108864;
                    int l = 16 - list.size() * p_193653_1_.func_192989_b().fontRenderer.FONT_HEIGHT / 2;

                    for (String s : list)
                    {
                        p_193653_1_.func_192989_b().fontRenderer.drawString(s, 30, l, 16777215 | i1);
                        l += p_193653_1_.func_192989_b().fontRenderer.FONT_HEIGHT;
                    }
                }
            }
