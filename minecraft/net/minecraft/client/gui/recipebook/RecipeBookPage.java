...
public class RecipeBookPage
{
    ...
    public void func_194191_a(int p_194191_1_, int p_194191_2_, int p_194191_3_, int p_194191_4_, float p_194191_5_)
    {
        if (this.field_193737_b > 1)
        {
            ...
            int i = this.field_193754_s.fontRenderer.getStringWidth(s);
            this.field_193754_s.fontRenderer.drawString(s, p_194191_1_ - i / 2 + 73, p_194191_2_ + 141, -1);
        }
        ...
        else
        {
            for (GuiButtonRecipe guibuttonrecipe : this.field_193743_h)
            {
                if (guibuttonrecipe.mousePressed(this.field_193754_s, p_194196_1_, p_194196_2_))
                {
                    ...
                    {
                        this.field_194202_c.func_191845_a(this.field_193754_s, guibuttonrecipe.func_191771_c(), guibuttonrecipe.x, guibuttonrecipe.y, p_194196_4_ + p_194196_6_ / 2, p_194196_5_ + 13 + p_194196_7_ / 2, (float)guibuttonrecipe.getButtonWidth(), this.field_194204_k);
                    }
