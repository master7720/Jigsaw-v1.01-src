...
public class GuiRecipeBook extends Gui implements IRecipeUpdateListener
{
    ...
    public void func_193014_a(boolean p_193014_1_, InventoryCrafting p_193014_2_)
    {
        ...
        this.field_193962_q = new GuiTextField(0, this.field_191888_F.fontRenderer, i + 25, j + 14, 80, this.field_191888_F.fontRenderer.FONT_HEIGHT + 5);
    ...
    private void func_193716_a(String p_193716_1_)
    {
        if ("excitedze".equals(p_193716_1_))
        {
            ...
            this.field_191888_F.fontRenderer.setUnicodeFlag(this.field_191888_F.getLanguageManager().isCurrentLocaleUnicode() || this.field_191888_F.gameSettings.forceUnicodeFont);
            this.field_191888_F.fontRenderer.setBidiFlag(languagemanager.isCurrentLanguageBidirectional());
