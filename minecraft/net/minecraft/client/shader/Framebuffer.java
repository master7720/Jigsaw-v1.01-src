...
public class Framebuffer
{
    ...
    public void framebufferRenderExt(int x, int y, int width, int height, boolean p_178038_3_)
    {
        if (OpenGlHelper.isFramebufferEnabled()) {
            ...
            GlStateManager.ortho(x, (double)width + x, (double)height + y, y, 1000.0D, 3000.0D);
            GlStateManager.matrixMode(5888);
            GlStateManager.loadIdentity();
            GlStateManager.translate(0.0F, 0.0F, -2000.0F);
            GlStateManager.viewport(x, y, width + x, height + y);
            ...
            bufferbuilder.pos(x, (double)f1, 0.0D).tex(0.0D, 0.0D).color(255, 255, 255, 255).endVertex();
            bufferbuilder.pos((double)f, (double)f1, 0.0D).tex((double)f2, 0.0D).color(255, 255, 255, 255).endVertex();
            bufferbuilder.pos((double)f, y, 0.0D).tex((double)f2, (double)f3).color(255, 255, 255, 255).endVertex();
            bufferbuilder.pos(x, y, 0.0D).tex(0.0D, (double)f3).color(255, 255, 255, 255).endVertex();
            tessellator.draw();
            this.unbindFramebufferTexture();
    ...
    public void framebufferRenderExtNoSetupMatrix(int width, int height, boolean p_178038_3_, boolean doPreSetup)
    {
        if (OpenGlHelper.isFramebufferEnabled())
        {
        	GlStateManager.colorMask(true, true, true, false);
            ...
            bufferbuilder.pos((double)w, (double)h, 0.0D).tex((double)f2, 0.0D).color(255, 255, 255, 255).endVertex();
            bufferbuilder.pos((double)w, 0.0D, 0.0D).tex((double)f2, (double)f3).color(255, 255, 255, 255).endVertex();
            bufferbuilder.pos(0.0D, 0.0D, 0.0D).tex(0.0D, (double)f3).color(255, 255, 255, 255).endVertex();
            tessellator.draw();
            this.unbindFramebufferTexture();
            GlStateManager.depthMask(true);
    ...
    public void framebufferRenderExtScale(int width, int height, boolean p_178038_3_, double scale)
    {
        if (OpenGlHelper.isFramebufferEnabled())
        {
        	GlStateManager.colorMask(true, true, true, false);
