...
public class TileEntityRendererDispatcher
{
    ...
    public <T extends TileEntity> TileEntitySpecialRenderer<T> getSpecialRendererByClass(Class teClass)
    {
        ...
        {
            tileentityspecialrenderer = this.<T>getSpecialRendererByClass(teClass.getSuperclass());
