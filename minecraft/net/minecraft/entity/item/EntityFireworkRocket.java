        ...
        if (this.func_191511_j())
        {
            ...
            if (this.field_191513_e != null)
            {
                if (this.field_191513_e.isElytraFlying())
                {
                    ...
                    double d0 = 1.5D;
                    double d1 = 0.1D;
                    this.field_191513_e.motionX += vec3d.x * 0.1D + (vec3d.x * 1.5D - this.field_191513_e.motionX) * 0.5D;
                    this.field_191513_e.motionY += vec3d.y * 0.1D + (vec3d.y * 1.5D - this.field_191513_e.motionY) * 0.5D;
                    this.field_191513_e.motionZ += vec3d.z * 0.1D + (vec3d.z * 1.5D - this.field_191513_e.motionZ) * 0.5D;
                }
